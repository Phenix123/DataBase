...
<?php
    ...
    $query = "SELECT players.FIO, teamstoplayers.TeamId FROM players JOIN teamstoplayers on players.id = teamstoplayers.PlayerId WHERE teamstoplayers.TeamId = 15";
    ...
    echo "<table><tr><th>Фамилия</th><th>Команда</th></tr>";
    for ($i = 0 ; $i < $rows ; ++$i)
    {
